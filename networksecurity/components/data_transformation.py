...
data_transformation_config:DataTransformationConfig):
    ...
    def get_data_transformer_object(self)->Pipeline:
        ...
        try: 
            ...
            logging.info(f"initialized the KNNImputer object with the parameters: {DATA_TRANSFORMATION_IMPUTER_PARAMS}")
    ...
    def initiate_data_transformation(self)->DataTransformationArtifact:
        ...
        try:
            logging.info(f"Starting the data transformation component")
            train_df = DataTransformation.read_data(self, self.data_validation_artifacts.valid_train_file_path)
            test_df = DataTransformation.read_data(self, self.data_validation_artifacts.valid_test_file_path)
